...
const HeroSection: React.FC = () => {
  ...
  return <section ref={heroRef} className="relative pt-24 pb-16 min-h-screen flex flex-col justify-center overflow-hidden" style={{
    '--x-offset': '0px',
    '--y-offset': '0px'
  } as React.CSSProperties}>
      {/* Background grid with parallax effect */}
      <div className="absolute inset-0 bg-grid opacity-30 will-change-transform" style={{
      ...
      <div className="absolute right-0 top-20 opacity-10 w-1/3 h-1/3 overflow-hidden z-0">
        <img src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?q=80&w=1200&auto=format&fit=crop" alt="" className="w-full h-full object-cover" />
      </div>
      ...
      {/* Gradient orb */}
      <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-fluxfx-500/30 filter blur-3xl will-change-transform opacity-60" style={{
      transform: 'translate3d(calc(var(--x-offset) * -0.5), calc(var(--y-offset) * -0.5), 0)'
    }} />
      
      <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-fluxfx-700/20 filter blur-3xl will-change-transform opacity-60" style={{
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="heading-xl text-gradient animate-fade-in-up pb-2" style={{
          animationDelay: '200ms'
        }}>
            Decentralising the Centralised
          </h1>
          
          <p className="paragraph mt-6 max-w-2xl mx-auto animate-fade-in-up" style={{
          ...
          <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-up" style={{
        ...
        <div className="mt-20 grid grid-cols-1 gap-6 sm:grid-cols-3 animate-fade-in-up" style={{
