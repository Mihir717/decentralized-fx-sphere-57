...
const TradingAssets: React.FC = () => {
  return (
    <section id="trading-assets" className="section-padding bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-full md:w-1/2 h-64 opacity-5 z-0 overflow-hidden">
        <img 
          src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?q=80&w=1500&auto=format&fit=crop"
          alt=""
      ...
      <div className="absolute bottom-0 left-0 w-full md:w-1/3 h-64 opacity-5 z-0 overflow-hidden">
        <img 
          src="https://images.unsplash.com/photo-1590283603385-c1e84fe52760?q=80&w=1500&auto=format&fit=crop"
          alt=""
          className="w-full h-full object-cover"
        />
      </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {forexPairs.map((pair, index) => (
                <div 
                  key={pair.name}
                  className="glass-card rounded-xl p-6 transition-all duration-300 hover:shadow-xl relative overflow-hidden"
                >
              ...
              <div className="lg:w-1/3 mb-8 lg:mb-0">
                <div className="glass-card rounded-xl h-full overflow-hidden shadow-md">
                  <AspectRatio ratio={16/9} className="bg-slate-100">
                    <img 
                      src="https://images.unsplash.com/photo-1589758438368-0ad531db3366?q=80&w=1000&auto=format&fit=crop" 
                      alt="Commodity Trading"
                      className="object-cover w-full h-full opacity-80"
                    />
                  </AspectRatio>
                  <div className="p-6">
                    <h4 className="font-bold text-lg mb-2">Trade Commodities</h4>
                    <p className="text-sm text-muted-foreground">
                      Access global commodity markets with tight spreads and advanced charting tools.
                    </p>
                  </div>
                </div>
              </div>
